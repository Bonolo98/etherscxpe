...
export default function ContactPage() {
  ...
  const handleOnSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      handleServerResponse(
        response.ok,
        response.ok ? "Thank you for your message. We'll get back to you soon!" : data.error,
      )
  ...
  return (
    <div className="w-full max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 p-4 md:p-8">
      {/* Contact Information */}
      <div className="shadow-input rounded-2xl bg-white p-6 dark:bg-black">
        <h2 className="text-2xl font-bold text-neutral-800 dark:text-neutral-200 mb-6">Get in Touch</h2>
        ...
        <div className="space-y-6">
          <div className="flex items-start space-x-4">
            ...
            <div>
              <h3 className="font-medium text-neutral-800 dark:text-neutral-200">Address</h3>
              <p className="mt-1 text-neutral-600 dark:text-neutral-400">{contactInfo.address}</p>
            </div>
          </div>
          ...
          <div className="flex items-start space-x-4">
            ...
            <div>
              <h3 className="font-medium text-neutral-800 dark:text-neutral-200">Email</h3>
              <p className="mt-1 text-neutral-600 dark:text-neutral-400">{contactInfo.email}</p>
            </div>
          </div>
          ...
          <div className="flex items-start space-x-4">
            ...
            <div>
              <h3 className="font-medium text-neutral-800 dark:text-neutral-200">Phone</h3>
              <p className="mt-1 text-neutral-600 dark:text-neutral-400">{contactInfo.phone}</p>
            </div>
          </div>
          ...
          <div className="flex items-start space-x-4">
            ...
            <div>
              ...
              <p className="mt-1 text-neutral-600 dark:text-neutral-400">{contactInfo.hours}</p>
            </div>
          </div>
        </div>
      ...
      {/* Contact Form */}
      <div className="shadow-input rounded-2xl bg-white p-6 dark:bg-black">
        <h2 className="text-2xl font-bold text-neutral-800 dark:text-neutral-200 mb-6">Send Us a Message</h2>
